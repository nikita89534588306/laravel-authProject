...
@section('content')
    ...
    <main class="flex flex-col justify-center p-6 pb-12">
        @php  $LANG_CONST = 'messages.registration.header.' @endphp
        <div class="mx-auto max-w-md">
            ...
            <h2 class="mt-2 text-2xl font-bold text-gray-900 sm:mt-6 sm:text-3xl">{{__($LANG_CONST.'textHeader')}}</h2>
        </div>
        <div class="mx-auto mt-6 w-full max-w-md rounded-xl bg-white/80 p-6 shadow-xl backdrop-blur-xl sm:mt-10 sm:p-10">
            ...
            <form action="{{ route('register') }}" method="post" novalidate autocomplete="off" class="space-y-6">
                @csrf
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700">{{__($LANG_CONST.'name.label')}}</label>
                    <div class="relative mt-1 rounded-md shadow-sm">
                        ...
                        <input type="text" id="name" name="name" required class="w-full rounded-md border-gray-300 pl-10 text-sm focus:border-green-500 focus:ring-green-500" placeholder="{{__($LANG_CONST.'name.placeholder')}}" />
                    </div>
                </div>

                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700">{{__($LANG_CONST.'email.label')}}</label>
                    <div class="relative mt-1 rounded-md shadow-sm">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3">
                        ...
                        <input type="email" id="email" name="email" class="w-full rounded-md border-red-300 pl-10 pr-10 text-sm text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500" placeholder="{{__($LANG_CONST.'email.placeholder')}}" />
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-gray-700">{{__($LANG_CONST.'password.label')}}</label>
                    <div class="relative mt-1 rounded-md shadow-sm">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3">
                            <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <input type="password" id="password" name="password" minlength="8" class="w-full rounded-md border-gray-300 pl-10 text-sm focus:border-green-500 focus:ring-green-500" placeholder="{{__($LANG_CONST.'password.placeholder')}}" />
                    </div>
                </div>

                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700">{{__($LANG_CONST.'confirmPassword.label')}}</label>
                    <div class="relative mt-1 rounded-md shadow-sm">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3">
                            <svg class="h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation" minlength="8" class="w-full rounded-md border-gray-300 pl-10 text-sm focus:border-green-500 focus:ring-green-500" placeholder="{{__($LANG_CONST.'confirmPassword.placeholder')}}" />
                    </div>
                </div>
                <div>
