@php 
    // TODO: Переделать все на компоненты
@endphp
        ...
        <div class="mx-auto mt-6 w-full max-w-md rounded-xl bg-white/80 p-6 shadow-xl backdrop-blur-xl sm:mt-10 sm:p-10">
            ...
            <form action="{{ route('register') }}" method="post" novalidate autocomplete="off" >
                    ...
                    <div class="relative mt-1 rounded-md shadow-sm">
                        ...
                        <input type="text" id="name" name="name" required 
                            class="
                                ...
                                @enderror 
                                "
                            placeholder="{{__($LANG_CONST.'name.placeholder')}}"
                            value="{{ old('name') }}"
                        />
                ...
                <div class="mb-6">
                    ...
                    <div class="relative mt-1 rounded-md shadow-sm">
                        ...
                        <input 
                            ...
                            class="
                                ...
                                @enderror 
                                "
                            placeholder="{{__($LANG_CONST.'email.placeholder')}}"
                            value="{{ old('email') }}"
                        />
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                            @error('email')    
                    ...
                    @error('email')  <p class="mt-2 text-sm text-red-600">{{ ucfirst($message) }}</p> @enderror 
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="relative mt-1 rounded-md shadow-sm">
                        ...
                        class="
                                ...
                                @enderror 
                                "
                                placeholder="{{__($LANG_CONST.'password.placeholder')}}"
                        />
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3">
                            @error('password')    
                                <svg class="h-5 w-5 text-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    @error('password')  <p class="mt-2 text-sm text-red-600">{{ ucfirst($message) }}</p> @enderror 
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="relative mt-1 rounded-md shadow-sm">
                        ...
                        <input 
                            type="password" id="password_confirmation" name="password_confirmation" minlength="8" 
                            class="w-full rounded-md border-gray-300 pl-10 text-sm focus:border-green-500 focus:ring-green-500" placeholder="{{__($LANG_CONST.'confirmPassword.placeholder')}}" />
                    </div>
                </div>
                <div class="mb-6">
